...
// part: rectangular_block (units: mm)
// step 'base_block' — base box
let s0 = box(50, 30, 20).translate(0, 0, -20/2);
s0 = _place(s0, 0.0, 0.0, 10.0, 0.0, 0.0, 0.0);
let result = s0;

return { "rectangular_block": result };