...
// part: cylindrical_rod (units: mm)
// step 'rod_base' — base cylinder
let s0 = cylinder(150, 4).translate(0, 0, -150/2);
s0 = _place(s0, 0.0, 0.0, 75.0, 0.0, 0.0, 0.0);
let result = s0;

return { "cylindrical_rod": result };