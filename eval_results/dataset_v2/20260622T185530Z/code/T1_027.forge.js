...
// part: filleted_rectangular_block (units: mm)
// step 'base_block' — base filleted_box
let s0 = (() => { const b = box(70, 40, 25); return fillet(b, 5, selectEdges(b)).translate(0, 0, -25/2); })();
s0 = _place(s0, 0.0, 0.0, 12.5, 0.0, 0.0, 0.0);
let result = s0;

return { "filleted_rectangular_block": result };