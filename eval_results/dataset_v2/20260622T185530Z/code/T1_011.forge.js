...
// part: rectangular_bar (units: mm)
// step 'base_bar' — base box
let s0 = box(200, 10, 10).translate(0, 0, -10/2);
s0 = _place(s0, 0.0, 0.0, 5.0, 0.0, 0.0, 0.0);
let result = s0;

return { "rectangular_bar": result };