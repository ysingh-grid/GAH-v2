...
// part: cylinder_part (units: mm)
// step 'cylinder_base' — base cylinder
let s0 = cylinder(40, 12.5).translate(0, 0, -40/2);
s0 = _place(s0, 0.0, 0.0, 20.0, 0.0, 0.0, 0.0);
let result = s0;

return { "cylinder_part": result };