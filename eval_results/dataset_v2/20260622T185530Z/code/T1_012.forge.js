...
// part: triangular_prism (units: mm)
// step 'prism_base' — base prism
let s0 = ngon(3, 15).rotate(90 % (360 / 3), [0, 0, 1]).extrude(50);
s0 = _place(s0, 0.0, 0.0, -25.0, 0.0, 0.0, 0.0);
let result = s0;

return { "triangular_prism": result };