...
def main():
    ...
    # 4) BROKEN: declared 100mm but built 40mm -> bbox audit must FAIL
    results.append(run("broken_wrong_size", [
        {"sequence_id": 1, "primitive_type": "box", "parameters": {"length": 40, "width": 20, "height": 10}, "operation": "new", "rationale": "body that is smaller than declared"},
    ], declared=[100, 50, 25], expect_pass=False))
