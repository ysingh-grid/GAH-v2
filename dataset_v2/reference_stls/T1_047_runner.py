...
try:
    ...
    exec(open("/Users/ysingh/PycharmProjects/Capstone-v0.1/CADSmith/data/dataset_v2/reference_stls/T1_047_script.py").read(), _autofab_user_globals)
    ...
    if _autofab_result is None:
        ...
        # Export STEP and STL
        cq.exporters.export(_autofab_result, "/Users/ysingh/PycharmProjects/Capstone-v0.1/CADSmith/data/dataset_v2/reference_stls/T1_047.step")
        cq.exporters.export(_autofab_result, "/Users/ysingh/PycharmProjects/Capstone-v0.1/CADSmith/data/dataset_v2/reference_stls/T1_047.stl")
